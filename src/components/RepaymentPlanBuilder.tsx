      ...
      <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl border border-slate-100 overflow-hidden relative">
        ...
        <div className="bg-slate-900 px-4 sm:px-6 py-5 flex justify-between items-center text-white">
          ...
          <div className="flex items-center gap-2">
            <Calculator className="w-4.5 h-4.5 text-amber-400 animate-pulse" />
          ...
          <div className="flex flex-col gap-6 pt-2">
            ...
            <div className="space-y-5">
              <div className="flex items-center gap-2 pb-2.5 border-b border-slate-100">
                <Wallet className="w-4 h-4 text-amber-600 animate-pulse" />
              ...
              <div className="p-4 bg-slate-50/40 hover:bg-slate-50/80 rounded-2xl border border-slate-100 transition-all duration-200 space-y-3">
                ...
                <div className="px-1 py-1">
                  <input
                    ...
                    className="w-full accent-amber-600 h-2 bg-slate-200/80 rounded-lg cursor-pointer transition-all"
                  />
                </div>
              ...
              <div className="p-4 bg-gradient-to-br from-amber-50/10 to-amber-100/10 hover:from-amber-50/20 hover:to-amber-100/20 rounded-2xl border border-amber-200/40 transition-all duration-200 space-y-3">
                <div className="flex justify-between items-center sm:px-1">
                  <span className="text-xs font-black text-slate-700 flex items-center gap-1.5">
                    <span className="w-1.5 h-1.5 bg-amber-500 rounded-full" />
                    자산 보유 가액 (청산 가치)
                  </span>
                  <span className="text-base font-black text-amber-800">{formatManWon(netAsset)}</span>
                </div>
                <div className="px-1 py-1">
                  <input
                    type="range"
                ...
                <div className="flex justify-between text-[9px] text-slate-400 font-bold items-center sm:px-1">
                  <span>0원 (무관)</span>
                  <span className="text-amber-700 font-black text-[9px] bg-amber-100/60 px-2 py-0.5 rounded-full">
                    ※ 청산가치 보장 원칙 준수
                  </span>
              ...
              <div className="p-4 bg-slate-50/40 hover:bg-slate-50/80 rounded-2xl border border-slate-100 transition-all duration-200 space-y-3">
                <div className="flex justify-between items-center pb-1">
                  ...
                  <span className="text-[10px] bg-amber-100/85 text-amber-800 px-2.5 py-0.5 rounded-full font-extrabold">2026 최저 생계비 기준</span>
                </div>
                  ...
                  {[1, 2, 3, 4, 5, 6, 7].map((count) => (
                    <button
                      ...
                      className={`py-2 px-1 rounded-xl border text-center font-extrabold text-[11px] transition-all cursor-pointer ${
                        dependents === count
                          ? 'bg-amber-600 border-amber-600 text-white shadow-sm scale-102'
                ...
                <div className="p-3 bg-white rounded-xl border border-slate-100 flex items-start gap-2.5 text-xs text-slate-500 font-medium font-sans mt-2 shadow-3xs">
                  ...
                  <div className="space-y-0.5">
                    <div className="font-extrabold text-slate-800 text-[11px]">
                      {dependents}인 최저생계비: <span className="text-amber-700">{livingCost.toLocaleString()}원</span> (약 {formatManWon(livingCost)})
                    </div>
              ...
              <div className="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch">
                  ...
                  <div>
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <div className="p-3 bg-white/5 rounded-xl border border-white/5 space-y-1">
                          <span className="text-[9px] text-amber-400 block font-semibold">원금 예상 탕감액</span>
                          <span className="text-xs font-black text-amber-300 block">{formatManWon(totalSavings)}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="md:col-span-5 flex flex-col justify-center pl-0 md:pl-2">
                  {isIncomeTooLow ? (
                    ...
                    <div className="p-3.5 rounded-xl bg-amber-500/10 border border-amber-500/25 flex flex-col gap-2 w-full">
                      <div className="flex justify-between items-center w-full">
                        <span className="text-xs text-slate-300 font-bold">총 채무 대비 감면율:</span>
                        <span className="text-sm font-black text-amber-400">{reductionPercent}% 탕감 예상</span>
                      </div>
                      <div className="w-full bg-white/10 rounded-full h-1.5 overflow-hidden">
                        <div className="bg-amber-400 h-full transition-all duration-300" style={{ width: `${reductionPercent}%` }} />
                      </div>
                      {estimatedPaymentMonthly * 36 >= netAsset && surplusIncome < monthlyRequiredByAsset && (
                        <p className="text-[9px] text-amber-300 leading-normal font-semibold border-t border-white/5 pt-1.5 mt-1">
