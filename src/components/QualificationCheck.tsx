    ...
    <div className="max-w-xl mx-auto px-2 sm:px-4 py-4 sm:py-8 md:py-12" id="qualification-inner-container">
      <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl border border-slate-100 overflow-hidden relative">
        ...
        <div className="bg-slate-900 px-4 sm:px-6 py-4 flex justify-between items-center text-white">
          ...
          <span className="text-[10px] font-black px-2.5 py-1 rounded-full bg-slate-800 text-amber-400">
            {progressPercent}% 완료
          </span>
        </div>
        ...
        <div className="w-full bg-slate-100 h-1.5 overflow-hidden">
          <div
            className="h-full bg-gradient-to-r from-amber-500 to-amber-700 transition-all duration-300 ease-out"
                  ...
                  <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 flex flex-col items-center justify-center space-y-3 font-sans">
                    ...
                    <div className="flex items-center gap-1.5 justify-center">
                      <input
                        ...
                        className="w-36 text-center text-3xl font-black text-slate-800 bg-white border border-slate-300 focus:border-amber-500 focus:ring-1 focus:ring-amber-500 rounded-xl py-2 px-1 focus:outline-none transition-all shadow-3xs"
                      />
            ...
            <div className="flex gap-2.5">
              ...
              {currentStep < QUESTIONS.length - 1 ? (
                QUESTIONS[currentStep].id === 'monthlyIncome' || QUESTIONS[currentStep].id === 'debtAmount' ? (
                  <div className="flex-1 text-center py-4 text-[13px] sm:text-sm text-amber-700 font-extrabold flex items-center justify-center select-none bg-amber-50/30 border border-dashed border-amber-200/50 rounded-xl leading-snug px-2">
                ...
                <button
                  ...
                  className="flex-1 py-4.5 rounded-xl bg-amber-600 hover:bg-amber-700 text-white font-black text-sm tracking-wide shadow-lg shadow-amber-950/15 hover:scale-[1.01] transition-all flex items-center justify-center gap-1.5 cursor-pointer active:scale-95 duration-100"
                >
